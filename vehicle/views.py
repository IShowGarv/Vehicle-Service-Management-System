...
def start_streamlit(request):
    try:
        streamlit_path = os.path.join(os.path.dirname(__file__), "../predictive_maintenance/app/app.py")
        subprocess.Popen(["streamlit", "run", streamlit_path])
        return HttpResponse("Streamlit app is starting... <a href='http://localhost:8501' target='_blank'>Click here to open</a>")
